...
<body class="bg-gray-100 text-gray-800">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-100">
                            ...
                            <td class="px-6 py-4 text-center">
                                <button onclick="openEditModal('{{ $estudiante->codigoEstudiantil }}', '{{ $estudiante->ID_Usuario }}')" class="text-indigo-600 hover:text-indigo-900">
                                    Editar
                                </button>
    ...
    <form method="POST" action="{{ route('estudiantes.cambiarEstado', $estudiante->codigoEstudiantil) }}" class="inline-block">
        @csrf
        <button type="submit" class="text-orange-600 hover:text-orange-900" onclick="return confirm('¿Está seguro que desea deshabilitar este estudiante?')">
            Deshabilitar
        </button>
    </form>
@else
    <form method="POST" action="{{ route('estudiantes.cambiarEstado', $estudiante->codigoEstudiantil) }}" class="inline-block">
        @csrf
        <button type="submit" class="text-green-600 hover:text-green-900" onclick="return confirm('¿Está seguro que desea habilitar este estudiante?')">
            Habilitar
        </button>
    </form>
@endif
