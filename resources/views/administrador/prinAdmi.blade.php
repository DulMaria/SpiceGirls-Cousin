                    ...
                    <div class="bg-white rounded-xl shadow-md p-6 transition-transform duration-300 hover:scale-105">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-2xl font-semibold text-purple-900">{{ $cursoMasCursado }}</p>
                                <p class="text-green-500 mt-1 text-sm flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18" />
                                    </svg>
                                    +{{ $porcentajeMasCursado }}% este mes
                                </p>
                            </div>
                ...
                <div class="bg-white rounded-xl shadow-md p-6 transition-transform duration-300 hover:scale-105">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <div class="flex flex-col gap-1 mt-2">
                                <p class="text-lg text-purple-900 font-semibold">Mujeres: {{ $distribucion['mujeres'] }}%</p>
                                <p class="text-lg text-purple-700 font-semibold">Hombres: {{ $distribucion['hombres'] }}%</p>
                                @if ($distribucion['otros'] > 0)
                                    <p class="text-lg text-purple-500 font-semibold">Otros: {{ $distribucion['otros'] }}%</p>
                                @endif
                            </div>
                        </div>
                        <div class="bg-purple-100 p-3 rounded-lg">
                    ...
                    <div class="mt-3">
                        <div class="w-full bg-gray-200 rounded-full h-2.5">
                            <div class="bg-purple-900 h-2.5 rounded-full" style="width: {{ $distribucion['mujeres'] }}%"></div>
                        </div>
                    </div>
                </div>
